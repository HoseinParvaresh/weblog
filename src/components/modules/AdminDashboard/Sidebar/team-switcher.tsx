          ...
          >
            ...
            </DropdownMenuLabel>
            {
              teams.map((team, index) => (
                ...
                >
                  <div className="flex items-center justify-center size-6 rounded-md border">
            ...
            <DropdownMenuItem className="gap-2 p-2 dir-rtl">
              <div className="flex items-center justify-center size-6 rounded-md border bg-transparent">
